...
| [**Chirper Server**](https://github.com/nek00oo/Chirper-SDUI-Server) | 🧠 Backend for dynamic UI rendering using Server-Driven UI approach with personalization based on user data and JSON templates. | Java 21, Spring Boot, SDUI, MongoDB, PostreSQL, Redis |
...
| [**Configurator (2 lab) && FileSystem CLI (4 lab)**](https://github.com/nek00oo/OOP-Csharp_ITMO)| ⚙️ Course project featuring advanced OOP and patterns: builder-based configurator, extendable validation with Chain of Responsibility, adapter-based messaging, and a powerful CLI parser using Iterator, Command, and Visitor patterns. | C#, OOP, Design Patterns |
...
| [**Parser (1 lab) && Machine Learning (other)**](https://github.com/nek00oo/IS_ML) | 🔍 Data scraping & model training to classify tanks from tanks.gg, optimized for performance. | Python, Selenium, scikit-learn |
